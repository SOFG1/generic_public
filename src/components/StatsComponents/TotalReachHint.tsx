...
const TotalReachHint = React.memo(() => {
  ...
  return (
    <>
      <StyledTitle>{t("total-reach_hint-title")}</StyledTitle>
      <StyledText>{t("total-reach_hint-text")}</StyledText>
