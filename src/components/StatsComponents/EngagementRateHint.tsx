...
const EngagementRateHint = React.memo(() => {
  ...
  return (
    <>
      <StyledTitle>{t("engagement-rate_hint-title")}</StyledTitle>
      <StyledText>{t("engagement-rate_hint-text")}</StyledText>
...
export default EngagementRateHint;
